...
//    그래서 wave21+ 빨강 2→5%, wave36+ 무지개 2→5%로 소량만 섞어 시각적 보상과 밴드를 양립시킨다.
//    초록은 1웨이브부터 등장(초반 파랑 일변도 해소).
...
const GEM_TIER_TABLE: ReadonlyArray<readonly [number, readonly [number, number, number, number, number]]> = [
  [5,   [0.85,  0.15,  0.00, 0.00, 0.00]], // E≈1.30 — 초록을 1웨이브부터
  [10,  [0.78,  0.20,  0.02, 0.00, 0.00]], // E≈1.54 — 노랑 조기 소량
  [15,  [0.75,  0.22,  0.03, 0.00, 0.00]], // E≈1.65
  [20,  [0.80,  0.15,  0.05, 0.00, 0.00]], // E≈1.65 (killrate 캡 흡수)
  [25,  [0.73,  0.20,  0.05, 0.02, 0.00]], // E≈1.83 — 빨강 첫 등장을 wave21+로 앞당김
  [30,  [0.805, 0.115, 0.05, 0.03, 0.00]], // E≈2.00
